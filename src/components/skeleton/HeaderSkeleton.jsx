...
const HeaderSkeleton = () => {
  return (
    ...
    <div className="hidden z-0 sm:absolute sm:-top-10 sm:right-1/2 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl pointer-events-none" aria-hidden="true">
        <div className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-fuchsia-200 to-lime-100 opacity-20" 
        >
        </div>
    </div>
    <div className="absolute z-0 -top-52 left-1/2 -translate-x-1/2 transform-gpu blur-3xl sm:top-[-28rem] sm:ml-16 sm:translate-x-0 sm:transform-gpu pointer-events-none" aria-hidden="true">
        <div className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-fuchsia-900 to-lime-700 opacity-20" >
        </div>
    </div>
         ...
         <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full relative z-10 md:gap-10 gap-6 pb-8">
                  <div className="rounded-2xl group/blog relative">
                    <div className="flex flex-col items-start justify-between w-full bg-white rounded-2xl rounded-br-none shadow-xl shadow-gray-300">
                        <Skeleton className="w-full aspect-[385/221] rounded-2xl rounded-br-none" width="385" height="217" src="https://images.pexels.com/photos/1413412/pexels-photo-1413412.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" />
                        <div className="w-full p-6">
                            <div className="flex items-center gap-x-4 text-xs">
                                  <Skeleton datetime="2023-11-27" className="text-gray-500">Jun 20, 2024</Skeleton>
                                <Skeleton href="#" className="relative z-20 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100">Bike</Skeleton>
                            </div>
                            <div className="group">
                                <Skeleton href="#" className="mt-3 text-lg font-semibold leading-6 text-gray-900 group-hover:text-gray-600 line-clamp-2 before:absolute before:inset-0 before:z-10">
                                HOW TO SAFELY MOUNT A BACKPACK ON A MOTORCYCLE?                               </Skeleton>
                                <Skeleton className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">
                                When it comes to hitting the open road on a motorcycle, carrying essentials is a must. Whether it's a daily commute or a long-distance adventure, having a reliable method to transport your belongin...
                                </Skeleton>
                            </div>
                            <div className="relative mt-8 flex items-center gap-x-4">
                                <Skeleton src="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="h-10 w-10 rounded-full bg-gray-50 object-cover"/>
                                <div className="text-sm leading-6">
                                    <Skeleton className="font-semibold text-gray-900">Written by</Skeleton>
                                    <Skeleton className="text-gray-600">Deepak Gill</Skeleton>
                                </div>
                            </div>
                        </div>
                    </div>
       ...
       flex-wrap justify-between">
        <div className="xl:max-w-[770px] w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 mt-2">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <Skeleton
                href="javascript:;"
                className="inline-flex text-teal-900  font-medium text-sm py-1 px-3 rounded-full"
              >
                Health
              </Skeleton>
            </div>
          ...
          <div className="mt-10">
            ...
            <ul className="flex flex-col gap-4 mt-5">
              <Skeleton className="flex gap-2 text-body">
                <span>1.</span>
                <Skeleton>
          ...
          <div className="flex flex-wrap gap-8 mt-12">
            ...
            <div className="max-w-[617px]">
              <Skeleton className="font-medium text-black text-[22px] leading-7 mb-3">
              ...
              <div className="flex items-center gap-1.5 mt-5">
                ...
                >
                  ...
                  >
                    <Skeleton
                      d="M10.4 8.58585V6.07664C10.4 5.10529 11.2059 4.31785 12.2 4.31785H14V1.67966L11.5565 1.50912C9.47255 1.36368 7.7 2.97636 7.7 5.01777V8.58585H5V11.224H7.7V12H10.4V11.224H13.1L14 8.58585H10.4Z"
                      fill=""
                    ></Skeleton>
                  </svg>
                </Skeleton>
        ...
        <div className="max-w-[370px] w-full">
          <div className="flex flex-col gap-10">
            <div className="max-w-[370px] w-full rounded-[10px] border border-gray-3 p-4 sm:p-7 lg:p-10">
              ...
              <div className="flex flex-col gap-7">
                <a href="blog-single-3.html" className="group flex gap-2">
                  <div className="max-w-[70px] *:size-full w-full aspect-[1/1] overflow-hidden rounded-full">
                    <Skeleton
            ...
            <div className="max-w-[370px] w-full rounded-[10px] border border-gray-3 p-4 sm:p-7 lg:p-10">
              <Skeleton className="font-semibold text-custom-4 text-black mb-8">
                Explore Topics
              </Skeleton>
              <div className="flex flex-col gap-3">
                ...
                >
                  ...
                  <Skeleton className="flex items-center justify-center max-w-[32px] w-full h-8 rounded-full text-custom-sm border border-gray-3 ease-in duration-200 ">
                    02
                  </Skeleton>
                </a>
