...
export default function DashboardTable({handleOpenTagModel}) {
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between gap-3 items-end">
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={handleOpenTagModel} className="hover:bg-black text-black bg-white border-2 border-black hover:text-white  hover:font-semibld" endContent={<PlusIcon />}>
              Add New
            </Button>
          </div>
        </div>
