            ...
            <a href="author.html" className="group">
              <div className="border border-gray-3 rounded-[20px] bg-gray-50 p-5 group-hover:bg-white group-hover:drop-shadow-1 group-hover:-translate-y-2 transition-all">
                <div className="flex flex-wrap items-center gap-8">
                  <div
                    div
                    className="w-20 h-20 rounded-full overflow-hidden *:size-full *:object-cover "
                  >
                    <img
                      src="https://images.unsplash.com/photo-1573496527892-904f897eb744?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      alt="user"
                    />
                  </div>
                  <div>
            ...
            <a href="author.html" className="group">
              <div className="border border-gray-3 rounded-[20px] bg-gray-50 p-5 group-hover:bg-white group-hover:drop-shadow-1 group-hover:-translate-y-2 transition-all">
                <div className="flex flex-wrap items-center gap-8">
                  <div className="w-20 h-20 rounded-full overflow-hidden *:size-full *:object-cover">
                    <img
                      src="https://images.unsplash.com/photo-1530268729831-4b0b9e170218?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      alt="user"
                    />
                  </div>
                  <div>
