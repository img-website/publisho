...
<main className="p-2 text-zinc-700 flex items-center justify-center">
    <button
      className="relative group transition-all duration-200 focus:overflow-visible w-40 h-max p-2 overflow-hidden flex flex-row justify-center bg-white gap-2 rounded-lg border border-zinc-200">
      <span>
        Sort by
      </span>
      ...
      <div
        className="absolute z-40 shadow-lg -bottom-40 left-0 w-full h-max p-2 bg-white border border-zinc-200 rounded-lg flex flex-col gap-2">
    ...
    <details className="group">
            <summary
                className="flex cursor-pointer list-none items-center justify-between py-4 text-lg font-medium text-secondary-900 group-open:text-black">
                Category
                <div>
            ...
            <a href="#" className="group/edit flex items-center justify-between group:hover/edit:bg-white gap-2 my-2">
