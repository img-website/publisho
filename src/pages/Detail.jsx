...
<img src="https://clarity-tailwind.preview.uideck.com/images/blog-single-03.png" alt="blog" className="w-full mb-10"/>
...
<a href="author.html" className="flex h-10 w-10 *:size-full rounded-full overflow-hidden">
...
<a href="category.html" className="inline-flex text-teal-900 bg-teal-100 font-medium text-sm py-1 px-3 rounded-full">
Health
</a>
</div>
</div>
...
<a href="author.html" className="flex items-center justify-center gap-3.5 mt-5">
...
<img src="https://clarity-tailwind.preview.uideck.com/images/blog-single-06.png" alt="blog" className="size-full object-cover" />
</div>
...
<span>1.</span>
<p>
<span className="text-black font-semibold">Sed ullamcorper dui at risus</span>
...
<span>2.</span>
<p>
<span className="text-black font-semibold">Everything about your</span>
...
<span>3.</span>
<p>
<span className="text-black font-semibold">Nulla id quam</span>
...
<a href="#" className="flex items-center justify-center w-7 h-7 rounded-full bg-[#364E8F] ease-in duration-200 hover:bg-opacity-95">
...
<a href="#" className="flex items-center justify-center w-7 h-7 rounded-full bg-[#52A2EC] ease-in duration-200 hover:bg-opacity-95">
<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<a href="author.html" className="flex max-w-24 w-full h-24 rounded-full overflow-hidden">
<img src="	https://clarity-tailwind.preview.uideck.com/images/user-02.png" alt="user" />
</a>
...
<a href="#" className="flex items-center justify-center w-7 h-7 rounded-full hover:bg-gray-2 transition-all duration-200 hover:text-black">
<svg className="fill-current" width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.4 8.58585V6.07664C10.4 5.10529 11.2059 4.31785 12.2 4.31785H14V1.67966L11.5565 1.50912C9.47255 1.36368 7.7 2.97636 7.7 5.01777V8.58585H5V11.224H7.7V12H10.4V11.224H13.1L14 8.58585H10.4Z" fill=""></path>
</svg>
</a>
<a href="#" className="flex items-center justify-center w-7 h-7 rounded-full hover:bg-gray-2 transition-all duration-200 hover:text-black">
<svg className="fill-current" width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<form>
<input id="email" type="email" name="email" placeholder="Enter your Email" className="rounded-md border border-gray-3 bg-white placeholder:text-black-5 w-full py-3.5 px-5 outline-none text-center focus:shadow-input focus:ring-2 focus:ring-dark-4/20 focus:border-transparent" />
...
<label for="sideToggle" class="fixed inset-0 -z-[1011] backdrop-blur-xl bg-blue-500/10 overflow-hidden peer-checked/sideToggle:z-[1010] peer-checked/sideToggle:opacity-100 opacity-0 duration-100"></label>
    ...
    <div class="flex items-center justify-between border-b pb-3">
        <div class="h-10 flex">
            <a href="index.html" class="-ml-1.5 flex items-center">
              <img src="./assets/img/fantasy-logo.png" alt="logo" class="size-full " />
            </a>
        </div>
         ...
         <div class="space-y-2 py-6 w-full">
             <div class="flex flex-col gap-5 items-center w-full">
                 <div class="flex flex-col w-full gap-y-3">
                   <a href="index.html" class="text-sm font-medium text-white">Home</a>
                   <a href="about.html" class="text-sm font-medium text-white">About</a>
                   <a href="work.html" class="text-sm font-medium text-white">Work</a>
                    <a href="blog.html" class="text-sm font-medium text-white"> Blogs</a>
                    <a href="contact.html" class="text-sm font-medium text-white"> Contact Us</a>
                 </div>
             </div>
         </div>
     </div>
