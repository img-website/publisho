      ...
      <div className="max-w-7xl  px-6 lg:px-8 w-full pt-20 mx-auto border-b py-5 mb-4">
        <div className="flex flex-col lg:flex-row items-center gap-7.5 xl:gap-14">
          <div className="lg:max-w-[570px] w-full rounded-md overflow-hidden aspect-[1/.6] *:h-full">
            <img
              src="https://images.unsplash.com/photo-1664574654700-75f1c1fad74e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dGVhbXxlbnwwfHwwfHx8MA%3D%3D"
              alt="about"
          ...
          <div className="8 mt-10 mx-auto border-b overflow-hidden bg-white shadow-2xl p-2 rounded-xl w-full flex flex-col lg:flex-row lg:items-center gap-7.5 lg:gap-11 my-10">
            <div className="lg:max-w-[536px] w-full aspect-[1/.8]">
              <a href="blog-single.html">
                <img
                  className="size-full shadow-2xl object-cover rounded-xl"
                  src="https://images.unsplash.com/photo-1614165936126-2ed18e471b3b?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA"
                  alt="hero"
                />
              </a>
            </div>
            <div className="lg:max-w-[540px] w-full mt-4 lg:mt-0">
              <a
                href="category.html"
                className="inline-flex text-violet-700 bg-violet-200/60 font-medium text-sm py-1 px-3 rounded-full mb-4"
              >
                Bikes
              </a>
          ...
          <div className="grid lg:grid-cols-2 gap-4 ">
            ...
            <div className=" flex bg-white rounded-xl shadow-2xl p-2 flex-col sm:flex-row sm:items-center gap-6 shadow-1">
              <div className="w-full aspect-[1/.6]">
                <a href="blog-single.html">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1574484184081-afea8a62f9c0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTczfHxmb29kfGVufDB8fDB8fHww"
                    alt="hero"
                  />
                </a>
              </div>
              <div className=" w-full">
                <a
                  href="category.html"
                  className="inline-flex text-yellow-900 bg-yellow-100/50 font-medium text-sm py-1 px-3 rounded-full mb-4"
                >
                  Food
                </a>
                <h2 className="font-semibold text-custom-lg text-dark mb-3">
