...
<h2 className="font-medium text-heading-5 [font-family:'Painting_With_Chocolate'] text-3xl md:text-5xl text-dark">Our Team</h2>
...
<rect width="18" height="18" fill="white"></rect>
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            <div className="shadow-xl dark:shadow-box-dark group mb-8 rounded-[5px] bg-white px-5 pb-10 pt-12 dark:bg-dark">
              <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img src="https://demo.tailgrids.com/templates/agency/build/src/assets/images/team/image-07/image-02.png" alt="team image" className="h-[120px] w-[120px] rounded-full" />
              ...
              <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-5">
                  <a href="javascript:void(0)" className="text-dark-8 hover:text-primary">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            <div className="shadow-xl dark:shadow-box-dark group mb-8 rounded-[5px] bg-white px-5 pb-10 pt-12 dark:bg-dark">
              <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img src="https://demo.tailgrids.com/templates/agency/build/src/assets/images/team/image-07/image-03.png" alt="team image" className="h-[120px] w-[120px] rounded-full" />
                <span className="absolute bottom-0 left-0 -z-10 h-10 w-10 rounded-full bg-secondary opacity-0 transition-all group-hover:opacity-100"></span>
                <span className="absolute right-0 top-0 -z-10 opacity-0 transition-all group-hover:opacity-100">
                  <svg width="45" height="53" viewBox="0 0 45 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.54166 3.1009C3.39795 3.1009 4.09211 2.40674 4.09211 1.55045C4.09211 0.69416 3.39795 0 2.54166 0C1.68537 0 0.991211 0.69416 0.991211 1.55045C0.991211 2.40674 1.68537 3.1009 2.54166 3.1009Z" fill="#3056D3"></path>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4 ">
            <div className="shadow-xl dark:shadow-box-dark group mb-8 rounded-[5px] bg-white px-5 pb-10 pt-12 dark:bg-dark">
              <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img src="https://demo.tailgrids.com/templates/agency/build/src/assets/images/team/image-07/image-01.png" alt="team image" className="h-[120px] w-[120px] rounded-full"/>
                <span className="absolute bottom-0 left-0 -z-10 h-10 w-10 rounded-full bg-secondary opacity-0 transition-all group-hover:opacity-100"></span>
                <span className="absolute right-0 top-0 -z-10 opacity-0 transition-all group-hover:opacity-100">
                  <svg width="45" height="53" viewBox="0 0 45 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.54166 3.1009C3.39795 3.1009 4.09211 2.40674 4.09211 1.55045C4.09211 0.69416 3.39795 0 2.54166 0C1.68537 0 0.991211 0.69416 0.991211 1.55045C0.991211 2.40674 1.68537 3.1009 2.54166 3.1009Z" fill="#3056D3"></path>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            <div className="shadow-xl dark:shadow-box-dark group mb-8 rounded-[5px] bg-white px-5 pb-10 pt-12 dark:bg-dark">
              <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img src="https://demo.tailgrids.com/templates/agency/build/src/assets/images/team/image-07/image-04.png" alt="team image" className="h-[120px] w-[120px] rounded-full" />
                <span className="absolute bottom-0 left-0 -z-10 h-10 w-10 rounded-full bg-secondary opacity-0 transition-all group-hover:opacity-100"></span>
                <span className="absolute right-0 top-0 -z-10 opacity-0 transition-all group-hover:opacity-100">
                  <svg width="45" height="53" viewBox="0 0 45 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.54166 3.1009C3.39795 3.1009 4.09211 2.40674 4.09211 1.55045C4.09211 0.69416 3.39795 0 2.54166 0C1.68537 0 0.991211 0.69416 0.991211 1.55045C0.991211 2.40674 1.68537 3.1009 2.54166 3.1009Z" fill="#3056D3"></path>
